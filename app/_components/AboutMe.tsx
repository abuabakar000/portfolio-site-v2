                    ...
                    <div className="md:col-span-7">
                        <div className="text-lg text-muted-foreground max-w-[450px]">
                            <p className="slide-up-and-fade">
                                I build fast, scalable, and responsive web
                                experiences with clean code, thoughtful
                                architecture, smooth interactions, and reliable
                                integrations.
                            </p>
                            <p className="mt-3 slide-up-and-fade">
                                I believe in a user-centered design approach,
                                ensuring that every project I work on is
                                tailored to meet the specific needs of its
                                users.
                            </p>
                        </div>
                    </div>
